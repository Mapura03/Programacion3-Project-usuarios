...
@router.get("/locations/{location_code}", response_model=Location)
def get_location(location_code: str, service: LocationService = Depends(get_location_service)) -> Location:
